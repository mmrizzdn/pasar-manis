...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="section">
        <div class="container">
            <h1>Data UMKM</h1>
            <div class="box">
                <p ><a href="UMKM-tambah.php">Tambah Data</a></p>
                <table border="1" cellspacing="0" class="table">
                    ...
                    <?php
                        ...
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td><?php echo $row['umkm_id'] ?></td>
                            <td><a href="menu-data.php?id=<?php echo $row['umkm_id'] ?>"><?php echo $row['name'] ?></a></td>
                            <?php
                            $file_info = pathinfo($row['gambar']);
                            $file_extension = strtolower($file_info['extension']);
                            ?>
                            
                            <td><img src="../UMKM/<?php echo $row['gambar']; ?>" width="200px"></td>
                            <td><?php echo $row['owner'] ?></td>
                            <td><?php echo $row['phone_number'] ?></td>
                            <td><?php echo $row['deskripsi'] ?></td>
                            <td>
                            <a href="UMKM-edit.php?id=<?php echo $row['umkm_id'] ?>">Edit</a> || <a href="proses-hapus.php?idu=<?php echo $row['umkm_id'] ?>">hapus</a>
                            </td>
                        </tr>
                        <?php
                        $no++;
