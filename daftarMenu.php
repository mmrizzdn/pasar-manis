        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-phone me-2"></i>Purwokerto, Banyumas</small>
            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Menu</h1>
                        <p class="fs-4 text-white mb-4 animated slideInDown">Temukan ragam menu kuliner malam yang menawarkan hidangan unik dan lezat. </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-warning px-3">Menu</h6>
                <h1 class="mb-5"><?php echo $_GET['name']; ?></h1>
            </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            ...
                            ?>
                            <img class="img-fluid" src="./menu/<?php echo $row['gambar']; ?>" alt="">
                        </div>
                        <div class="text-center p-4">
                            <h3 class="mb-0"><?php echo $row['name'] ?></h3>
                            <div class="mb-3">
                                <p style="margin: 0;">Rp. <?php echo $row['price'] ?></p>
